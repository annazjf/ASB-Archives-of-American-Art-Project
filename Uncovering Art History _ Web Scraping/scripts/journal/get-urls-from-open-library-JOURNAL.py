...
# Search query
parameters = {'q': '\"Archives of American Art Journal\"'}
...
url_column_index = 1
search_results_csv = "journal-search-results.csv"

# CHANGE this variable if more search result pages have been added
# To check, go to https://openlibrary.org/search/inside?q=%22Archives+of+American+Art+Journal%22
search_results_page_end = 65
...
def get_items(url):
    ...
    encoded_url ="%22Archives+of+American+Art+Journal%22"
        ...
        for result in soup.find_all(class_='sri__main'):
            ...
            # If result is new, add to csv
                ...
                try:
                    ...
                    if "Archives of American Art Journal" in author:
