...
filename = 'collections-search-results.csv'
...
Example url: https://archive.org/stream/leeredits00lade?ref=ol&access=1#search/%22Archives+of+American+Art%22
...
collections-search-results.csv, where new_row is the new row and file is the
